...
$sqlarray = $dict->CreateTableSQL(cms_db_prefix() . 'module_easylist_instances', $fields, $taboptarray);
...
$sqlarray = $dict->CreateTableSQL(cms_db_prefix() . 'module_easylist_fielddefs', $fields, $taboptarray);
$dict->ExecuteSQLArray($sqlarray);
...
$this->RegisterSmartyPlugin('EasyListLoader','function', array('EasyListSmarty', 'loader'));
