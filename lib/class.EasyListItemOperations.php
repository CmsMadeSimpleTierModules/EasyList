...
class EasyListItemOperations
{
	...
	static final public function Save(Easylist &$mod, EasyListItem &$obj)
	{
		Events::SendEvent($mod->GetName(), 'PreItemSave', array('item_object' => &$obj));

		// Check against mandatory list
		foreach(EasyListItem::$mandatory as $rule) {
	...
	static final public function Delete(Easylist &$mod, EasyListItem &$obj)
	{
	...
	static final public function Load(Easylist &$mod, EasyListItem &$obj, $row = false)
	{
	...
	static final public function Copy(EasyListItem $obj)	
	{
		$obj = clone $obj;
