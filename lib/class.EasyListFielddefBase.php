 ...
 * @since 1.3
 */
abstract class EasyListFielddefBase implements ArrayAccess
{
	#---------------------
	# Constants
	#---------------------
	...
	public final function SetParentArray(EasyListFielddefArray &$obj) {
	...
	************************************/
	...
	public function EventHandler()
	{
		...
		if(!isset($this->event_handler))
			$this->event_handler = new EasyListEventHandlerBase($this);
	...
	public final function ModLang()
	{
		...
		return EasyListLangOperations::li_lang_from_realm($this->originator, $args);
	}
...
{ 
	...
	public function __toString()
	{
		return (string)implode(EASYLIST_VALUE_SEPARATOR, (array)$this);
	}
