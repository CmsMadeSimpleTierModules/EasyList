...
class EasyListEventHandlerBase
{
	#---------------------
	# Attributes
	#---------------------
	...
	public function __construct(EasyListFielddefBase &$field)
	{
		$this->_field	 	= $field;
	}
	 ...
	 * @return void
	 */	
	public function OnItemSave(Easylist &$mod)
	{
		$db = cmsms()->GetDb();
	 ...
	 * @return void
	 */		
	public function OnItemLoad(Easylist &$mod)
	{
		$db = cmsms()->GetDb();
