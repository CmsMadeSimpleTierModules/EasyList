<?php
$lang['invalid_characters'] = 'Zeichen wie: %s sind nicht erlaubt mit diesen Feld: %s';
$lang['item'] = 'Eintrag';
$lang['items'] = 'Eintr&auml;ge';
$lang['fielddef'] = 'Extra-Feld';
$lang['fielddefs'] = 'Extra-Felder';
...
$lang['back'] = 'Eine Seite zur&uuml;ck';
$lang['prompt_fix_fielddefs'] = 'Versuche Reparatur der Datenbank Eintr&auml;ge f&uuml;r Extra-Felder';
$lang['message_fielddefs_fixed'] = 'Extra-Felder f&uuml;r alle Instanzen repariert.';
...
$lang['too_long'] = 'Feldwert &uuml;berschreitet maximale L&auml;nge';
$lang['approve'] = 'Status auf &#039;Aktiv&#039; setzen';
$lang['revert'] = 'Status auf &#039;Inaktiv&#039; setzen';
$lang['submit_order'] = 'Reihenfolge speichern';
$lang['delete_selected'] = 'Ausgew&auml;hlte %s l&ouml;schen';
$lang['areyousure_deletemultiple'] = 'Wollen Sie wirklich alle %s l&ouml;schen?';
$lang['select_all'] = 'Alle ausw&auml;hlen';
$lang['error_startgreaterend'] = 'FEHLER: Das Startdatum ist sp&auml;ter als das Enddatum.';
$lang['item_alias_exists'] = 'Alias des Eintrags existiert bereits. Der Alias ​​muss eindeutig sein.';
$lang['return_url'] = 'Zur&uuml;ck';
...
$lang['fielddef_deps'] = 'Modul Abh&auml;ngigkeiten';
...
$lang['fielddef_scan'] = 'Extra-Felder Scannen';
$lang['fielddef_scanned'] = 'Extra-Felder gescannt';
$lang['fielddef_type_notset'] = 'Extra-Feld Typ nicht definiert';
$lang['fielddef_friendlytype'] = 'Friendly Type';
$lang['fielddef_originator'] = 'Urspruing';
$lang['fielddef_max_length'] = 'maximale L&auml;nge';
$lang['fielddef_required'] = 'Erforderlich';
$lang['registered_fielddefs'] = 'Registrierte Extra-Felder';
$lang['fielddef_name_empty'] = 'Der Name des Extra-Felds ist leer';
$lang['fielddef_name_exists'] = 'Der Name des Extra-Felds existiert bereits';
...
$lang['invalid'] = 'Der Feldwert ist unzul&auml;ssig';
...
$lang['helptext_title'] = 'M&ouml;gliche Felddefinition Anweisungen f&uuml;r das Extra-Feld:';
$lang['fielddef_TextInput'] = 'Textfeld';
$lang['fielddef_Checkbox'] = 'Kontrollk&auml;stchen';
$lang['fielddef_TextArea'] = 'Textarea';
$lang['fielddef_SelectDate'] = 'Datum auswahl';
$lang['fielddef_SelectDateTime'] = 'Select DateTime';
$lang['fielddef_Dropdown'] = 'Dropdown';
$lang['fielddef_ContentPages'] = 'Inhaltsseiten';
$lang['fielddef_SelectFile'] = 'Datei auswahl';
$lang['fielddef_RadioGroup'] = 'Radioknopf-Guppe';
$lang['enable_jqui'] = 'jQuery-UI-Kn&ouml;pfe verwenden';
$lang['fielddef_Slider'] = 'Slider';
$lang['fielddef_MultiSelect'] = 'Mehrfachauswahl';
$lang['fielddef_CheckboxGroup'] = 'Kontrollk&auml;stchen-Gruppe';
...
$lang['fielddef_size_help'] = 'Gr&ouml;&szlig;e des Eingabefelds; z. B.: 20';
...
$lang['categorytemplate'] = 'Kategorie-Template';
$lang['categorytemplates'] = 'Kategorie-Templates';
...
$lang['searchtemplates'] = 'Such-Templates';
...
$lang['template_name_empty'] = 'Name des Templates ist leer';
$lang['template_content_empty'] = 'Template Inhalt ist leer';
$lang['default_templates'] = 'Standard Templates';
$lang['module_options'] = 'Modul-Optionen';
$lang['url_options'] = 'URL-Optionen';
$lang['default_options'] = 'Modul-Standards';
...
$lang['prompt_adminsection'] = 'Modul Admin-Bereich';
...
$lang['prompt_url_prefix'] = 'URL-Pr&auml;fix';
...
$lang['prompt_item_cols'] = 'Diese Felder in der &Uuml;bersicht zeigen';
...
$lang['options_notice'] = 'Nach &auml;nderung des Modul Anzeigenamens oder Admin-Bereichs, k&ouml;nnte  f&uuml;r die wirksame &Auml;nderungen &quot;Zwischenspeicher leeren&quot; Aktion erforderlich sein.';
...
$lang['installed_instances_warning'] = 'Unten ist eine Liste von duplizierten Modul-Instanzen.<br />Erstellen Sie eine Sicherung Ihrer Seite (Datenbank und Dateien) vor &quot;upgrade&quot; Aktion';
$lang['installed_instances'] = 'Installierte Instanzen';
$lang['instance_name'] = 'Instanz Name';
...
$lang['reset'] = 'Standard zur&uuml;cksetzen';
$lang['duplicate'] = 'Duplizieren';
$lang['changessaved'] = 'Ihre &Auml;nderungen wurden gespeichert.';
$lang['changessaved_create'] = 'Your previous item has been successfully saved. Create new item?';
$lang['templaterestored'] = 'Voreingestelltes Template wurde wiederhergestellt.';
...
$lang['deleted'] = 'Ihre Auswahl wurde gel&ouml;scht.';
$lang['add'] = '%s hinzuf&uuml;gen';
$lang['import'] = '%s importieren';
$lang['export'] = '%s exportieren';
$lang['alias'] = 'Alias ';
$lang['alias_invalid'] = 'Der Alias ​​ist ung&uuml;ltig. Es muss ein g&uuml;ltiger PHP-Variablennamen sein';
$lang['search'] = 'Suche';
...
$lang['module_name_empty'] = 'Modul Name ist leer';
$lang['module_name_invalid'] = 'Modul Name enth&auml;lt ung&uuml;ltige Zeichen';
$lang['modulecopied'] = 'Modul erfolgreich kopiert';
$lang['select_one'] = 'Bitte ausw&auml;hlen';
$lang['size'] = 'Gr&ouml;&szlig;e';
$lang['max_lenght'] = 'Maximale l&auml;nge';
...
$lang['exclude_prefix'] = 'Prefix ausschlie&szlig;en';
$lang['image'] = 'Bild';
$lang['file'] = 'Datei';
...
$lang['param_filter_missing'] = 'F&uuml;r den Filtermodus ist zwingend der Parameter <em>filter</em> erforderlich.';
$lang['all'] = 'Alle';
...
$lang['moddescription'] = 'ListIt erlaubt es Ihnen, Listen zu erstellen, die Sie auf Ihrer Website anzeigen k&ouml;nnen.';
...
$lang['upgrading'] = 'Upgraden';
$lang['smarty_plugins'] = 'Smarty Plugins';
$lang['about'] = '&Uuml;ber';
$lang['upgrade_from'] = 'Upgraden von';
$lang['team'] = 'Team';
...
$lang['help_categories'] = '<h3>Kategorien</h3>
	<p>Mehrschichtige Kategorien werden unterst&uuml;tzt.</p>';
...
$lang['help_param_action'] = '&Uuml;berschreiben der Standard-Aktion. M&ouml;gliche Werte sind:
<ul>
<li>&quot;default&quot; - zur Anzeige der Zusammenfassung.</li>
<li>&quot;detail&quot; - zur Anzeige der Detailseite.</li>
<li>&quot;search&quot; - zur Anzeige des Suchformulars.</li>
<li>&quot;filter&quot; - zur Anzeige des Filterformulars. Der Parameter <em>filter</em> MUSS angegeben werden.</li>
</ul>';
$lang['help_param_showall'] = 'Alle Eintr&auml;ge zeigen, unabh&auml;ngig von der Zeitsteuerung.';
$lang['help_param_category'] = 'Geben Sie einen oder mehrere Komma getrennte Alias von Kategorie(n) an, um nur Eintr&auml;ge aus diesen anzuzeigen.';
$lang['help_param_exclude_category'] = 'Geben Sie einen oder mehrere Komma getrennte Alias von Kategorie(n) an, um Eintr&auml;ge aus diesen auszuschlie&szlig;en.';
$lang['help_param_subcategory'] = 'Wenn Sie den Parameter &#039;category&#039; angegeben haben, k&ouml;nnen Sie mit <em>true</ em> auch Elemente aus Unterkategorien anzeigen. Standardm&auml;&szlig;ig ist der Wert auf false gesetzt.';
$lang['help_param_detailtemplate'] = 'Das Detail-Template, das Sie verwenden m&ouml;chten.';
$lang['help_param_summarytemplate'] = 'Das Zusammenfassungs-Template, das Sie verwenden m&ouml;chten. ';
$lang['help_param_searchtemplate'] = 'Das Such-Template, das Sie verwenden m&ouml;chten.';
...
$lang['help_param_pagelimit'] = 'Maximale Anzahl der anzuzeigenden Eintr&auml;ge (pro Seite). Wenn dieser Parameter nicht angegeben wird, werden alle passenden Eintr&auml;ge angezeigt. Wenn es ist, und es gibt mehr Eintr&auml;ge als im Parameter angegeben, wird der Text und Links angezeigt, um das Scrollen durch die Ergebnisse zu erm&ouml;glichen';
$lang['help_param_start'] = 'Beginnen beim n-ten Eintrag - beim leeren wert wird ab ersten Eintrag gestartet.';
$lang['help_param_number'] = 'Maximale anzahl der Eintr&auml;ge (pro Seite) - beim leeren wert werden alle Eintr&auml;ge angeizeigt. Dies ist ein Synonym f&uuml;r die pagelimit Parameter.';
$lang['help_param_detailpage'] = 'Seite f&uuml;r Eintragdetails. Muss ein Seitenalias sein. Wird verwendet, damit Details in einer anderen Seite als Zusammenfassung angezeigt werden.';
...
$lang['help_param_item'] = 'Dieser Parameter ist nur f&uuml;r die Detailansicht. Es erm&ouml;glicht die Angabe, welches Element im Detail-Modus angezeigt werden soll. Muss ein Element Alias ​​sein.';
$lang['help_param_search'] = 'Search all fields. Uses fulltext search. Can be combined with filter search.';
$lang['help_param_search_'] = 'Durchsucht ein bestimmtes Feld. Sie k&ouml;nnen &#039;title&#039; verwenden oder den Alias eines Extra-Felds, bspw. search_title. Bleibt unbeachtet, wenn der Parameter &#039;search&#039; gesetzt ist, jedoch ist die Kombination mehrerer search_* Parameter m&ouml;glich.';
...
$lang['help_param_debug'] = 'Erm&ouml;glicht Debug-Modus, Ausgabe aller Objekte, Arrays und Variablen f&uuml;r aktuelle Aktion.';
