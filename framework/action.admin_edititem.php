...
if (isset($params['cancel'])) {
	...
	easylist_utils::clean_params($params, array('page'), true);
...
$mode	      				= easylist_utils::init_var('mode', $params, 'edit');
$item_id      				= easylist_utils::init_var('item_id', $params, -1);
$title       			 	= easylist_utils::init_var('title', $params, '');
$alias		 			 	= easylist_utils::init_var('alias', $params, '');
$time_control 				= easylist_utils::init_var('time_control', $params, 0);
$active      			 	= 1;
