...
$item_query = new EasyListItemQuery($this, $params);

if(!$this->CheckPermission($this->_GetModuleAlias() . '_modify_all_item')) {

	$item_query->AppendTo(EasyListQuery::VARTYPE_WHERE, 'A.owner = ?');
	$item_query->AppendTo(EasyListQuery::VARTYPE_QPARAMS, get_userid(false));
}
...
while ($result && $row = $result->FetchRow()) {
	...
	EasyListItemOperations::Load($this, $obj, $row);	
