...
$category_id      			= easylist_utils::init_var('category_id', $params, -1);
$name       			 	= easylist_utils::init_var('name', $params, '');
$alias		 			 	= easylist_utils::init_var('alias', $params, '');
$description				= easylist_utils::init_var('description', $params, '');
$parent_id 				 	= easylist_utils::init_var('parent_id', $params, -1);
$active      			 	= 1;
