	...
	<div class="item">
		...
		<div class="item-properties">
			...
			*}
			...
			{* use EasyListLoader plugin if you need Category information in default module action templates *}
			{EasyListLoader item='category' force_array=1 value=$fielddef.value assign='cats'}
