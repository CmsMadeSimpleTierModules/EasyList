...
$invalid_names = array('easylist', 'original', 'xdefs', 'loader');
$modules = $this->ListModules();
foreach($modules as $mod) {

	$mod->module_name = substr($mod->module_name, strlen(EasyListDuplicator::MOD_PREFIX));
...
if (isset($params['submit'])) {
	...
	if (empty($errors)) {
		...
		$duplicator = new EasyListDuplicator($module_name);
